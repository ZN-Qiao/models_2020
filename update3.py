...
__all__ = ['update3_resnet18', 'update3_resnet34', 'update3_resnet50', 'update3_resnet101', 'update3_resnet152']
...
def update3_resnet18(pretrained=False, **kwargs):
...
def update3_resnet34(pretrained=False, **kwargs):
...
def update3_resnet50(pretrained=False, **kwargs):
...
def update3_resnet101(pretrained=False, **kwargs):
...
def update3_resnet152(pretrained=False, **kwargs):
...
def demo():
    ...
    for i in range(1):
        net = update3_resnet50(num_classes=1000)
