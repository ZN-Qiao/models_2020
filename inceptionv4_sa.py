...
def inceptionv4(num_classes=365, pretrained=None):
    if pretrained:
        print('pretrained')
        ...
        if pretrained == 'imagenet':
            new_last_linear = nn.Linear(1536, 365)
...
def demo():
    ...
    net = inceptionv4(pretrained=None)
