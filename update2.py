...
__all__ = ['update2_resnet18', 'update2_resnet34', 'update2_resnet50', 'update2_resnet101', 'update2_resnet152']
...
def update2_resnet18(pretrained=False, **kwargs):
...
def update2_resnet34(pretrained=False, **kwargs):
...
def update2_resnet50(pretrained=False, **kwargs):
...
def update2_resnet101(pretrained=False, **kwargs):
...
def update2_resnet152(pretrained=False, **kwargs):
...
def demo():
    ...
    for i in range(1):
        net = update2_resnet50(num_classes=1000)
