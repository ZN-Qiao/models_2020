...
__all__ = ['update4_resnet18', 'update4_resnet34', 'update4_resnet50', 'update4_resnet101', 'update4_resnet152']
...
def update4_resnet18(pretrained=False, **kwargs):
...
def update4_resnet34(pretrained=False, **kwargs):
...
def update4_resnet50(pretrained=False, **kwargs):
...
def update4_resnet101(pretrained=False, **kwargs):
...
def update4_resnet152(pretrained=False, **kwargs):
...
def demo():
    ...
    for i in range(1):
        net = update4_resnet50(num_classes=1000)
