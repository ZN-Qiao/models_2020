...
__all__ = ['update1_resnet18', 'update1_resnet34', 'update1_resnet50', 'update1_resnet101', 'update1_resnet152']
...
def update1_resnet18(pretrained=False, **kwargs):
...
def update1_resnet34(pretrained=False, **kwargs):
...
def update1_resnet50(pretrained=False, **kwargs):
...
def update1_resnet101(pretrained=False, **kwargs):
...
def update1_resnet152(pretrained=False, **kwargs):
...
def demo():
    ...
    for i in range(1):
        net = update1_resnet50(num_classes=1000)
