...
__all__ = ['update10_resnet18', 'update10_resnet34', 'update10_resnet50', 'update10_resnet101', 'update10_resnet152']
...
class ParamFree(nn.Module):
    ...
    def forward(self, x):
        ...
        gap2 = self.batch_norm(gap2)
        gap4 = self.batch_norm(gap4)
...
def update10_resnet18(pretrained=False, **kwargs):
...
def update10_resnet34(pretrained=False, **kwargs):
...
def update10_resnet50(pretrained=False, **kwargs):
...
def update10_resnet101(pretrained=False, **kwargs):
...
def update10_resnet152(pretrained=False, **kwargs):
...
def demo():
    ...
    for i in range(1):
        net = update10_resnet50(num_classes=1000)
