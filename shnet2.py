...
class shnet(nn.Module):
    def __init__(self, channel):
        ...
        self.conv1 = conv1x1(channel, channel)
        self.conv2 = conv1x1(channel, channel)
        self.conv3 = conv1x1(channel, channel)
        self.conv4 = conv1x1(channel, channel)
        self.conv5 = conv1x1(channel*4, channel*2)
